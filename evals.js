...
function screenBodies() {
  const h = S.home;
  return {
    welcome: [S.welcome.body, ...S.welcome.points],
    kyc: [S.kyc.sub],
    mfHome: [h.sub, h.once.body, h.ruleOpt.body, h.help.docsBefore, h.help.basicsBody],
    once: [S.once.out, S.once.docsNote, R.worstLine(500)],
